  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 px-6 md:px-16 lg:px-24 max-w-7xl">
        ...
        >
          Scale, reach, and cultural relevance combine to create one of the most
          powerful commercial ecosystems in the world.
        </motion.p>

        {/* 📊 Stats */}
        <div ref={ref} className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-10">
